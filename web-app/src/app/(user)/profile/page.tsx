		...
		<div className="container mx-auto px-12 lg:w-10/12">
			<div className="flex justify-between items-start">
				...
				<div className="w-2/3 space-y-8">
					...
					<div className="flex flex-row space-x-10 items-center pt-3 text-nowrap scrollbar-custom px-5">
						<a className="pb-3 border-black border-b-2" href="#">
							Trang chủ
						</a>
						<a
					...
					<div className="mt-8">
						<div className="flex flex-col space-y-2">
							...
							<div className="flex flex-row space-x-2">
								<a className="bg-blue-400 rounded-full px-4 py-2 text-white text-sm font-bold">
									Follow
								</a>
								<a
